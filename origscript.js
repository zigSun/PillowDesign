...
$(document).ready(function () {
    ...
    fontSelectComponent('#pillow-model-font');
    fontSelectComponent('#pillow-advanced-front-font');
    fontSelectComponent('#pillow-advanced-back-font');

    logoSelectComponent('#pillow-mark-front');
    logoSelectComponent('#pillow-mark-back');
...
function calculate_price() {
    ...
    var pillow_auto_model=$('#pillow-auto-model-text').val();
